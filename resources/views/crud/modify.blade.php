                ...
                <div class="selector-container" style="margin-top:2%;" >
                    <table id="selector-post" class="table table-striped" style="text-align:center;" >
                        <tr>
                            ...
                            <th style="text-align:center;" >Created On (UTC)</th>
                            <th style="text-align:center;" >Modified On (UTC)</th>
            ...
            <div class="modal-body">
                <form id="modi_form" enctype="multipart/form-data" >
                    <div class="form-group">
                        ...
                        <input type="hidden" id="post_mod" name="post_mod" />
...
<script type="text/javascript">
        ...
        success:function(data){
            if(data.data.length==0){
                ...
                for(var i=0;i<data.data.length;i++){
                    ...
                    created_on = moment.utc(data.data[i].created_on).format("ddd, Do MMM YYYY [at] HH:mm");
                    modified_on = moment.utc(data.data[i].modified_on).format("ddd, Do MMM YYYY [at] HH:mm");
                    id = data.data[i].id;
                    ...
                    $("#selector-post").append("<tr id='"+id+"' align='center' ><td>"+checkbox+"</td><td>"+title+"</td><td>"+description+"</td><td>"+created_on+"</td><td>"+modified_on+"</td><td>"+action+"</td></tr>");
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $("#post_year").val(moment().utc().format("YYYY-MM-DD HH:mm:ss"));
            $("#post_mod").val(moment().utc().format("YYYY-MM-DD HH:mm:ss"));
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $("#alert-success-modi").show();
                ...
                var y_d = moment($("#post_year").val()).format("ddd, Do MMM YYYY [at] HH:mm");
                var mod_d = moment($("#post_mod").val()).format("ddd, Do MMM YYYY [at] HH:mm");
                // console.log(y_d);
                $('table#selector-post tr#'+m_id).remove();
    
                $("#selector-post").append("<tr id='"+m_id+"' align='center' ><td>"+checkbox+"</td><td>"+m_t+"</td><td>"+m_d+"</td><td>"+y_d+"</td><td>"+mod_d+"</td><td>"+action+"</td></tr>");
